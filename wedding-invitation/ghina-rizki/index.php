<?php
include('../ghina-rizki/koneksi.php');
?>
<!DOCTYPE html>
<html lang="en-US">
...
<p>( QS. Ar- Rum 21 )</p></div>
			...
			<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular" >
				...
				<div class="et_pb_text_inner">
					<h1>Fadla Ghina Dayanti</h1>
                	<p><strong>Putri dari</strong><br> Bpk. Yana Jumhana<br> &amp; Ibu Dede Kurniasih</p>
				</div>
			</div> <!-- .et_pb_text -->
				...
				<div class="et_pb_text_inner">
					<h1>Muhammad Rizki Aflahul Muzhidin</h1>
                    <p><strong>Putra dari</strong><br> Bpk. Rosikin<br> &amp; Ibu Fajri Fauziyah</p>
				</div>
			</div> <!-- .et_pb_text -->
			</div> <!-- .et_pb_column -->
				...
				<div class="et_pb_module et_pb_countdown_timer et_pb_countdown_timer_0 et_pb_no_bg et_pb_bg_layout_light" data-end-timestamp="1632016800">
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description">
							<p>Minggu, 19 September 2021<br> 09.00 s/d 11.00 WIB<br> <strong>Grand Cordela Hotel Kuningan</strong><br> Jl. Siliwangi No.91, Purwawinangun, Kec. Kuningan,<br> Kabupaten Kuningan, Jawa Barat, 45511</p>
						</div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
	...
	<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular" >
						...
						<div class="swiper-container">
							<div class="swiper-wrapper">
									<?php
								      ...
								      $query = "SELECT * FROM tb_ghina ORDER BY id ASC";
			...
			<div id="et_pb_contact_form_0" class="et_pb_module et_pb_contact_form_0 et_pb_contact_form_container clearfix" >
				...
				<div class="et_pb_contact">
					<form method="post" action="../ghina-rizki/tambah_pesan.php">
